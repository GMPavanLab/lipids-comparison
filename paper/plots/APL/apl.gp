...
set output 'apl_final.pdf'

set ylabel 'Area per lipid [nm^{2}]'
unset xlabel
...
set obj rect from -1, 0.668 to 14, 0.698


p 'apl.dat' u 0:2:3 w yerr lc 'black' lw 1.5 notitle, 'apl.dat' u 0:2:0 w p palette lw 5 pt 7 notitle, 'apl.dat' u 0:2 w p lw 1 pt 6 ps 1.35 lc 'black' notitle, 0.684 w l dt 2 lw 3 lc 'black' t 'Kučerka et al. (2006)', 0.643 w l dt 4 lw 3  lc 'black' t 'Kučerka et al. (2011)' 
