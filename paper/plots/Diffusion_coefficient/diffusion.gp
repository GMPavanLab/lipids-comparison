...
set output 'diff_final.pdf'

set ylabel 'Diffusion Coefficient [10^{-5} cm^2/s]'
unset xlabel
...
p 'diffusion.dat' u 0:2:3 w yerr lc 'black' lw 1.5 notitle, 'diffusion.dat' u 0:2:0 w p palette lw 5 pt 7 notitle, 'diffusion.dat' u 0:2 w p lw 1 pt 6 ps 1.35 lc 'black' notitle
