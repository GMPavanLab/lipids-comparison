...
set output 'comp_final.pdf'

set ylabel 'Compressibility [N/m]'
unset xlabel
...
p 'compressibility.dat' u 0:2:3 w yerr lc 'black' lw 1.5 notitle, 'compressibility.dat' u 0:2:0 w p palette lw 5 pt 7 notitle, 'compressibility.dat' u 0:2 w p lw 1 pt 6 ps 1.35 lc 'black' notitle
